...
- **講者雙螢幕主控台（按 `P`）**：筆電開主控台（看講稿備註、縮圖清單、超時警示），投影機開全螢幕投影片，兩視窗透過 `localStorage` 毫秒級自動同步（斷網亦 100% 穩定）。
...
3. 拿起你的手機相機掃描，手機會開啟專屬遙控介面，立即享受在台上單手翻頁、隨時看講稿備忘與震動反饋！
...
| **`P`** | 開啟／關閉 **講者主控台**（含手機遙控、PACE 計時與縮圖） |
